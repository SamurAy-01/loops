...
let ogrenciler = [
    ...
    {"ad": "ada", "soyad": "bilgi", "notlar": [50,20,90]},
...
//     console.log(`${ogrenci.ad} ${ogrenci.soyad} isimli öğrencimin not ortalaması : ${ortalama}.`);   
